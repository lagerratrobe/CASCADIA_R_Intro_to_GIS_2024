...
-   Assess the influence of a coordinate reference system (CRS) on
    mapping
...
Check out the attributes of the raster, such as it's class, coordinate
...
# classes <- 
# Now classify the raster using "classify"
...
# Project the feature and make it into a multilinestring
...
feedback on earlier versions of this document. This work was funded by
the USDA National Institute of Food and Agriculture (NIFA) Agriculture
and Food Research Initiative (AFRI) grant no. 2022-68013-37138.
